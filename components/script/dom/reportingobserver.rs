...
use crate::dom::bindings::codegen::Bindings::ReportingObserverBinding::{
    Report, ReportBody, ReportList, ReportingObserverCallback, ReportingObserverMethods,
...
impl ReportingObserver {
    ...
    pub(crate) fn generate_and_queue_a_report(
        ...
        let report = Self::generate_a_report(global_scope, type_, None, body, destination);
        ...
        Self::notify_reporting_observers_on_scope(global_scope, &report);
