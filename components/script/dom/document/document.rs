...
impl Document {
    ...
    pub(crate) fn has_a_stylesheet_that_is_blocking_scripts(&self) -> bool {
        self.loading_handler
            .borrow()
            .as_ref()
            .is_none_or(|loading_handler| {
                loading_handler.has_a_stylesheet_that_is_blocking_scripts()
            })
    }

    pub(crate) fn add_script_blocking_stylesheet(&self, id: StylesheetContextId) {
        if let Some(loading_handler) = &*self.loading_handler.borrow() {
            loading_handler.add_script_blocking_stylesheet(id);
        }
    }

    pub(crate) fn remove_script_blocking_stylesheet(&self, id: StylesheetContextId) {
        if let Some(loading_handler) = &*self.loading_handler.borrow() {
            loading_handler.remove_script_blocking_stylesheet(id);
        }
    }
        ...
        match load {
            LoadType::Stylesheet(_) => {
                if let Some(loading_handler) = &*self.loading_handler.borrow() {
                    ...
                    loading_handler.process_pending_parsing_blocking_script(cx);
    ...
    pub(crate) fn start_the_end_loading_phase(&self) {
        if self.is_initial_about_blank() {
            // TODO(47417): Once "creating a new browsing context" properly exists, remove this check
            *self.loading_handler.borrow_mut() = None;
            // Could be `None` when we abort while loading
        } else if let Some(loading_handler) = &*self.loading_handler.borrow() {
    ...
    pub(crate) fn set_pending_parsing_blocking_script(
        ...
        if let Some(loading_handler) = &*self.loading_handler.borrow() {
            loading_handler.set_pending_parsing_blocking_script(script, load);
        }
    }
    ...
    pub(crate) fn has_pending_parsing_blocking_script(&self) -> bool {
        self.loading_handler
            .borrow()
            .as_ref()
            .is_none_or(|loading_handler| loading_handler.has_pending_parsing_blocking_script())
    }
    ...
    pub(crate) fn pending_parsing_blocking_script_loaded(
        ...
        if let Some(loading_handler) = &*self.loading_handler.borrow() {
            loading_handler.pending_parsing_blocking_script_loaded(cx, element, result);
        }
    }
    ...
    pub(crate) fn add_asap_script(&self, script: &HTMLScriptElement) {
        if let Some(loading_handler) = &*self.loading_handler.borrow() {
            loading_handler.add_asap_script(script);
        }
    }
    ...
    pub(crate) fn asap_script_loaded(
        ...
        if let Some(loading_handler) = &*self.loading_handler.borrow() {
            loading_handler.asap_script_loaded(cx, element, result);
        }
    }
    ...
    pub(crate) fn push_asap_in_order_script(&self, script: &HTMLScriptElement) {
        if let Some(loading_handler) = &*self.loading_handler.borrow() {
            loading_handler.push_asap_in_order_script(script);
        }
    }
    ...
    pub(crate) fn asap_in_order_script_loaded(
        ...
        if let Some(loading_handler) = &*self.loading_handler.borrow() {
            loading_handler.asap_in_order_script_loaded(cx, element, result);
        }
    }
    ...
    pub(crate) fn add_deferred_script(&self, script: &HTMLScriptElement) {
        if let Some(loading_handler) = &*self.loading_handler.borrow() {
            loading_handler.add_deferred_script(script);
        }
    }
    ...
    pub(crate) fn deferred_script_loaded(
        ...
        if let Some(loading_handler) = &*self.loading_handler.borrow() {
            loading_handler.deferred_script_loaded(cx, element, result);
        }
    }
...
impl Document {
    ...
    fn new_with_proto(
        ...
        document.initialize_loading_handler();
        {
